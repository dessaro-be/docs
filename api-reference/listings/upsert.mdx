...
<Warning>
  **PUT is a full replacement**
  ...
  The PUT operation replaces the entire listing. Fields not included in your request will be set to `null`.
  Always send ALL fields with every request, even when updating an existing listing.
</Warning>
